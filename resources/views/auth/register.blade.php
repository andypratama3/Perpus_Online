	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="{{ route('register') }}" class="login100-form validate-form" method="POST" enctype="multipart/form-data">
					@csrf
				...
				<div class="login100-more" style="background-image: url('asset_login/images/bg-01.jpg');">
				</div>
			</div>
		</div>
	</div>
