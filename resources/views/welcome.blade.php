...
<section id="hero" class="d-flex justify-content-center align-items-center" style="border-radius: 20px;">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
        ...
        <a href="{{ route('buku.index')  }}" class="btn-get-started">Get Started</a>
    </div>
</section><!-- End Hero -->
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                <div class="course-item">
                    ...
                    @endphp
                    <img src="{{ asset('storage/buku/cover/'. $firstCover) }}" class="img-fluid" alt="...">
                    <div class="course-content">
                        ...
                        <h3><a href="{{ route('buku.show', $buku->slug) }}">{{ $buku->name }}</a></h3>
